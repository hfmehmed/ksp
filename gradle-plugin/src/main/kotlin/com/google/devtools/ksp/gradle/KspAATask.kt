...
abstract class KspAAWorkerAction : WorkAction<KspAAWorkParameter> {
    override fun execute() {
        ...
        // Stale outputs are cleaned up by KSP itself: fully on a rebuild or a non-incremental
        // run, and per-file for outputs that are no longer generated. Wiping the whole
        // directory here would force every untouched output to be copied back afterwards.
